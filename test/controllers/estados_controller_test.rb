...
class EstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estado" do
    assert_difference('Estado.count') do
      post estados_url, params: { estado: { Estado: @estado.Estado, Nombre: @estado.Nombre, actualizado: @estado.actualizado, actualizado_por: @estado.actualizado_por, creado: @estado.creado, creado_por: @estado.creado_por } }
    end
  ...
  test "should update estado" do
    patch estado_url(@estado), params: { estado: { Estado: @estado.Estado, Nombre: @estado.Nombre, actualizado: @estado.actualizado, actualizado_por: @estado.actualizado_por, creado: @estado.creado, creado_por: @estado.creado_por } }
