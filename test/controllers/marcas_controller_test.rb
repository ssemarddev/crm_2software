...
class MarcasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marca" do
    assert_difference('Marca.count') do
      post marcas_url, params: { marca: { Estado: @marca.Estado, Nombre: @marca.Nombre, actualizado: @marca.actualizado, actualizado_por: @marca.actualizado_por, creado: @marca.creado, creado_por: @marca.creado_por } }
    end
  ...
  test "should update marca" do
    patch marca_url(@marca), params: { marca: { Estado: @marca.Estado, Nombre: @marca.Nombre, actualizado: @marca.actualizado, actualizado_por: @marca.actualizado_por, creado: @marca.creado, creado_por: @marca.creado_por } }
