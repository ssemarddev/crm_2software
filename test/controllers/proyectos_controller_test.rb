...
class ProyectosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proyecto" do
    assert_difference('Proyecto.count') do
      post proyectos_url, params: { proyecto: { actualizado: @proyecto.actualizado, actualizado_por: @proyecto.actualizado_por, creado: @proyecto.creado, creado_por: @proyecto.creado_por, estado: @proyecto.estado, nombre: @proyecto.nombre } }
    end
  ...
  test "should update proyecto" do
    patch proyecto_url(@proyecto), params: { proyecto: { actualizado: @proyecto.actualizado, actualizado_por: @proyecto.actualizado_por, creado: @proyecto.creado, creado_por: @proyecto.creado_por, estado: @proyecto.estado, nombre: @proyecto.nombre } }
