...
class PagosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago" do
    assert_difference('Pago.count') do
      post pagos_url, params: { pago: { actualizado: @pago.actualizado, actualizado_por: @pago.actualizado_por, cantidad: @pago.cantidad, creado: @pago.creado, creado_por: @pago.creado_por, documento_pago_id: @pago.documento_pago_id, interes: @pago.interes, mora: @pago.mora, observacion: @pago.observacion, referencia: @pago.referencia, status: @pago.status } }
    end
  ...
  test "should update pago" do
    patch pago_url(@pago), params: { pago: { actualizado: @pago.actualizado, actualizado_por: @pago.actualizado_por, cantidad: @pago.cantidad, creado: @pago.creado, creado_por: @pago.creado_por, documento_pago_id: @pago.documento_pago_id, interes: @pago.interes, mora: @pago.mora, observacion: @pago.observacion, referencia: @pago.referencia, status: @pago.status } }
